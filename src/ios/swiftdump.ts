...
export type Scope = '__enums__' | '__structs__' | '__classes__'

export function list(scope: Scope | string[] | string): string[] {
  if (scope === '__enums__') return;
  else if (scope === '__structs__') return ownClasses()
  else if (scope === '__classes__') return dump()
