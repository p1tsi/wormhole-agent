...
import { frameworkCFNetwork } from '../../lib/libraries';
...
const CFURLRequestSetHTTPRequestBody : IFunctionPointer = {
    ...
    ptr: Module.getExportByName(frameworkCFNetwork, 'CFURLRequestSetHTTPRequestBody'),
...
const CFURLRequestSetHTTPRequestBodyStream : IFunctionPointer = {
    ...
    ptr: Module.getExportByName(frameworkCFNetwork, 'CFURLRequestSetHTTPRequestBodyStream'),
    onEnter: function(args: InvocationArguments){
