...
function parseXPCBaseType(type, value){
    ...
    switch (type){
        ...
        case 'OS_xpc_data':
            ...
            break;
        case 'OS_xpc_shmem':
            //console.log(new ObjC.Object(value))
            let memAddr: NativePointer = Memory.allocUtf8String("");
            const size = xpc_shmem_map(value, memAddr);
            console.log("SH MEM: " + size + " BYTES");
            //console.log("SH MEM PTR: " + memAddr)
            //console.log(hexdump(memAddr));
            //console.log(memAddr.readByteArray(size.toNumber()))
        ...
        case 'OS_xpc_mach_send':
            //retval = new ObjC.Object(value).toString();
