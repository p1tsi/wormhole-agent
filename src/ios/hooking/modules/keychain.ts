...
import { frameworkSecurity } from '../../lib/libraries';
...
const SecItemCopyMatching : IFunctionPointer = {
    ...
    ptr: Module.getExportByName(frameworkSecurity, 'SecItemCopyMatching'),
...
const SecItemAdd : IFunctionPointer = {
    name: 'SecItemAdd',
    ptr: Module.getExportByName(frameworkSecurity, 'SecItemAdd'),
    onEnter: function(args: InvocationArguments){
...
const SecItemDelete : IFunctionPointer = {
    name: 'SecItemDelete',
    ptr: Module.getExportByName(frameworkSecurity, 'SecItemDelete'),
    onEnter: function(args: InvocationArguments){
        let query = new ObjC.Object(args[0]);
        query = cleanDictionary(query);
        send({
...
const SecItemUpdate : IFunctionPointer = {
    name: 'SecItemUpdate',
    ptr: Module.getExportByName(frameworkSecurity, 'SecItemUpdate'),
    onEnter: function(args: InvocationArguments){
        send({
            type: 'keychain',
            timestamp: Date.now(),
