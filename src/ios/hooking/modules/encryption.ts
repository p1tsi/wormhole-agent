...
import { libCommonCryptoDylib } from '../../lib/libraries';

const p_CCCryptorCreateWithMode = Module.getExportByName(libCommonCryptoDylib, "CCCryptorCreateWithMode");
const p_CCCryptorCreate = Module.getExportByName(libCommonCryptoDylib, "CCCryptorCreate");
const p_CCCryptorRelease = Module.getExportByName(libCommonCryptoDylib, "CCCryptorRelease");
const p_CCCryptorUpdate = Module.getExportByName(libCommonCryptoDylib, "CCCryptorUpdate");
const p_CCCryptorFinal = Module.getExportByName(libCommonCryptoDylib, "CCCryptorFinal");
const p_CCCryptorGetOutputLength = Module.getExportByName(libCommonCryptoDylib, "CCCryptorGetOutputLength");
