...
import { libSQLiteDylib } from '../../lib/libraries';
...
const p_sqlite3_bind_blob64 = Module.getExportByName(libSQLiteDylib, 'sqlite3_bind_blob64');
const p_sqlite3_bind_null = Module.getExportByName(libSQLiteDylib, 'sqlite3_bind_null');
...
const p_sqlite3_column_count = Module.getExportByName(libSQLiteDylib, 'sqlite3_column_count');
const p_sqlite3_column_blob = Module.getExportByName(libSQLiteDylib, 'sqlite3_column_blob');
