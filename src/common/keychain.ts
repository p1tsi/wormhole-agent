...
import * as CF from './lib/frameworks/CoreFoundation.js'
import * as Security from './lib/frameworks/Security.js'
...
for (let symbol of constants) {
  const p = Process.getModuleByName('Security').getExportByName(symbol)
  if (!p) {
