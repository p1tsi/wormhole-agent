...
import { frameworkCoreFoundation, libSystemNotify } from '../../lib/libraries';
...
const CFNotificationCenterAddObserver: IFunctionPointer = {
    ...
    ptr: Module.findExportByName(frameworkCoreFoundation, "CFNotificationCenterAddObserver"),   
    onEnter: function(args: InvocationArguments){
...
const NotifyPost: IFunctionPointer = {
    name: 'notify_post',
    ptr: Module.getExportByName(libSystemNotify, 'notify_post'),
    onEnter: function(args: InvocationArguments){
        send({
            type: 'notifications',
            timestamp: Date.now(),
...
const NotifyRegisterDispatch: IFunctionPointer = {
    ...
    ptr: Module.getExportByName(libSystemNotify, 'notify_register_dispatch'),
    onEnter: function(args: InvocationArguments){
...
const NotifyCancel: IFunctionPointer = {
    name: 'notify_cancel',
    ptr: Module.getExportByName(libSystemNotify, 'notify_cancel'),
    onEnter: function(args: InvocationArguments){
        if (!args[0].isNull()){
            send({
                type: 'notifications',
...
const NotifyGetState: IFunctionPointer = {
    ...
    ptr: Module.getExportByName(libSystemNotify, 'notify_get_state'),
    onEnter: function(args: InvocationArguments){
        if (!args[0].isNull()){
            send({
                type: 'notifications',
...
const CFNotificationCenterPostNotificationWithOptions: IFunctionPointer = {
    ...
    ptr: Module.getExportByName(frameworkCoreFoundation, 'CFNotificationCenterPostNotificationWithOptions'),
    onEnter: function(args: InvocationArguments){
        send({
            type: 'notifications',
            timestamp: Date.now(),
...
const CFNotificationCenterPostNotification: IFunctionPointer = {
    ...
    ptr: Module.getExportByName(frameworkCoreFoundation, 'CFNotificationCenterPostNotification'),
    onEnter: function(args: InvocationArguments){
        send({
            type: 'notifications',
            timestamp: Date.now(),
