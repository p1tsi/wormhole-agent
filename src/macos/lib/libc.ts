...
export const mmap = new NativeFunction(Module.findExportByName(null, 'mmap')!, 'pointer', ['pointer', 'uint', 'int', 'int', 'int', 'long'])
export const munmap = new NativeFunction(Module.findExportByName(null, 'munmap')!, 'int', ['pointer', 'uint'])
